...
INSERT INTO `keranjang` (`id`, `produkid`, `jumlah`, `isi_pesan`, `gambar`, `sub_total`, `plg_id`) VALUES
(49, 27, 15, 'asdasda', '', 139000, 'PLG2402270001');
...
--
ALTER TABLE `pembayaran`
  MODIFY `bayar_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
