							...
							<form id="register-form" method="post" action="<?= base_url('pelanggan/update') ?>" enctype="multipart/form-data">
								<div class="form-row">
									<div class="col">
										...
										<input type="text" id="nama" value="" name="nama" required>
									</div>
									<div class="col">
										<label for="email" class="rl-label required">Email </label>
										<input type="email" id="email" value="" name="email" required>
										<input type="hidden" id="email" value="" name="old_email" required>
									</div>
								</div>
								<div class="form-row">
									<div class="col">
										<label for="nama" class="rl-label">Telepon</label>
										<input type="text" id="telp" value="" name="telp" required>
									</div>
									<div class="col">
