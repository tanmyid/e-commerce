		...
		<div class="section">
			...
			<div class="sidebar left">
				...
				<div class="sidebar-item">
					...
					<?php foreach ($data_keranjang_pesanan as $tujuan) : ?>
						<label>Provinsi</label>
						<input type="text" name="provinsi" value="<?= $tujuan->provinsi; ?>" readonly>
						<label for="">Kota</label>
						<input type="text" name="kota" value="<?= $tujuan->kota; ?>" readonly>
						<input type="hidden" name="qty" value="<?= $tujuan->jumlah; ?>">
					<?php endforeach ?>
				</div>
				<!-- /SIDEBAR ITEM -->
