...
<head>
	...
	<title> <?= $title ?> | E-COMMERCE PERMATA DEWI</title>
	<style type="text/css">
...
<body>
	...
	<div class="header-wrap">
		<header>
			<!-- LOGO -->
			<a href="<?= base_url('assets/') ?>index.html" style="color: white; font-weight: bold; position: absolute; top: 50px; transform: translateY(-50%); left: 0;">
				<span style="font-size: 40px;">E-COMMERCE PERMATA DEWI</span>
			</a>
			<!-- /LOGO -->
			...
			<a href="#">
				<figure class="logo-mobile">
					<img src="<?php echo base_url('assets/') ?>	images/logo_mobile.png" style="width:80px;height:70px;display:block;margin:0 auto;">
				</figure>
			</a>
			<!-- /LOGO MOBILE -->
			<!-- USER BOARD -->
						...
						<a href="#">
							<div class="outer-ring">
								...
								<figure class="user-avatar">
									<img src="<?php
												if ($this->session->userdata('plg_nama') == "Laki - Laki") {
													echo base_url("assets/img/pelanggan/user-male.png");
												} else {
													echo base_url("assets/img/pelanggan/user-male.png");
												}
												?>" alt="avatar">
